...
function doubleTheFun(para) {
	...
	else if (isNaN(para) === true) {
		return para + para;
	}
	else if (isNaN(para) !== true) {
		var newNum = Number(para);
		return newNum * 2;
	}
}

// function doubleTheFun(para) {
// 	var answer = parseInt(para) * 2;
...
function makeChatMessage(msg, authorName) {
	var obj = {
		message: msg,
		author: authorName,
		timestamp: new Date()
